...
#define __U_MASK(_wc)  (uint32_t)(_wc & 0xFFFFF000)
#define __J_MASK(_wc)  ((int32_t)(_wc & 0x80000000) >> 11) | (_wc & 0xFF000) | ((_wc >> 9) & 0x800) | ((_wc >> 20) & 0x7FE)
#define __I_MASK(_wc)  ((int32_t)(_wc & 0xFFF00000) >> 20)
#define __S_MASK(_wc)  ((int32_t)(_wc & 0xFE000000) >> 20) | ((_wc >> 7) & 0x1F)
#define __B_MASK(_wc)  ((int32_t)(_wc & 0x80000000) >> 19) | ((_wc & 0x80) << 4) | ((_wc >> 20) & 0x7E0) | ((_wc >> 7) & 0x1E)
